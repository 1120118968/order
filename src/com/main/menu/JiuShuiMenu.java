...
public class JiuShuiMenu extends Activity {
    ...
    private CheckBox.OnCheckedChangeListener listener = new CheckBox.OnCheckedChangeListener() {
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (c2.isChecked() == true && ax1 == true) {
                ...
                ContentValues values = new ContentValues();
                values.put("name", ss1);
                values.put("url", ss2 + "元" + "             ");
                values.put("desc", ss3 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            }
            ...
            if (c3.isChecked() == true && ax2 == true) {
                ...
                values.put("url", sss2 + "元" + "             ");
                values.put("desc", sss3 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            ...
            if (c4.isChecked() == true && ax3 == true) {
                ...
                values.put("url", ssss2 + "元" + "             ");
                values.put("desc", ssss3 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            }
            ...
            if (c5.isChecked() == true && ax4 == true) {
                ...
                values.put("url", sssss2 + "元" + "             ");
                values.put("desc", sssss3 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            }
            ...
            if (c6.isChecked() == true && ax5 == true) {
                ...
                ContentValues values = new ContentValues();
                values.put("name", s6);
                values.put("url", ss6 + "元" + "             ");
                values.put("desc", sss6 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            }
            ...
            if (c7.isChecked() == true && ax6 == true) {
                ...
                ContentValues values = new ContentValues();
                values.put("name", s7);
                values.put("url", ss7 + "元" + "             ");
                values.put("desc", sss7 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            }
            ...
            if (c8.isChecked() == true && ax7 == true) {
                ...
                ContentValues values = new ContentValues();
                values.put("name", s8);
                values.put("url", ss8 + "元" + "             ");
                values.put("desc", sss8 + "瓶");
                DBHelper helper = new DBHelper(getApplicationContext());
                helper.insert(values);
                helper.close();
            }
    ...
    protected void dialog(String msg) {
  	  AlertDialog.Builder builder = new Builder(JiuShuiMenu.this);
